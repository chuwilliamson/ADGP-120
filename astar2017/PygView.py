...
class PygView(object):
    ...
    def paint(self):
        ...
        pygame.draw.polygon(self.background, (0, 180, 0),
                            ((250, 100), (300, 0), (350, 50)))
        # pygame.draw.arc(Surface, color, Rect, start_angle, stop_angle,
        # width=1): return Rect
        pygame.draw.arc(self.background, (0, 150, 0), (400, 10,
                                                       150, 100), 0, 3.14)  # radiant instead of grad
        # ------------------- blitting a Ball --------------
        self.myball = Ball()  # creating the Ball object
        self.myball.blit(self.background)  # blitting it
...
class Ball(object):
    ...
    def __init__(self, radius=50, color=(0, 0, 255), x=320, y=240):
        ...
        # pygame.draw.circle(Surface, color, pos, radius, width=0) # from
        ...
        # self.surface = self.surface.convert_alpha() # faster blitting with
        # transparent color
