...
class BuildExe:
    def __init__(self):
        ...
        self.license = "Astar License"
 
        #Auhor of program
        self.author_name = "Matthew Williamson"
        self.author_email = "chuwilliamson@gmail.com"
        self.copyright = "Copyright (c) 2016 Me."
 
        #Description
        self.project_description = "Astar implementation"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["audio"]
